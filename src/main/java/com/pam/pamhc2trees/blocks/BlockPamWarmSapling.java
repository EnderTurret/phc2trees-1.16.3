...
public class BlockPamWarmSapling extends BushBlock implements BonemealableBlock {
	...
	private final FeatureHolder<WarmFruitTreeFeature, TreeConfig> feature;

	public BlockPamWarmSapling(Block.Properties properties, FeatureHolder<WarmFruitTreeFeature, TreeConfig> feature) {
		super(properties);
