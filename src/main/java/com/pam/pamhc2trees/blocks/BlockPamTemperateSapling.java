...
public class BlockPamTemperateSapling extends BushBlock implements BonemealableBlock {

	public static final IntegerProperty STAGE = BlockStateProperties.STAGE;
	protected static final VoxelShape SHAPE = Block.box(2.0D, 0.0D, 2.0D, 14.0D, 12.0D, 14.0D);
	private final FeatureHolder<TemperateFruitTreeFeature, TreeConfig> feature;

	public BlockPamTemperateSapling(Block.Properties properties, FeatureHolder<TemperateFruitTreeFeature, TreeConfig> feature) {
		super(properties);
