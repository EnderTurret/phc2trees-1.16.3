...
public class ColdFruitTreeFeatureSapling extends Feature<NoneFeatureConfiguration> {
	public ColdFruitTreeFeatureSapling(Codec<NoneFeatureConfiguration> configFactory) {
		super(configFactory);
	}
