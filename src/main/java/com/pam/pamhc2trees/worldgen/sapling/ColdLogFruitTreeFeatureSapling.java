...
public class ColdLogFruitTreeFeatureSapling extends Feature<NoFeatureConfig> {
	public ColdLogFruitTreeFeatureSapling(Codec<NoFeatureConfig> configFactory) {
		super(configFactory);
	}
	...
	private static BlockState getFruit(int verify, Random random)
	{
		...
		return BlockRegistry.pammaple.defaultBlockState().setValue(BlockStateProperties.AGE_7, Integer.valueOf(0));
