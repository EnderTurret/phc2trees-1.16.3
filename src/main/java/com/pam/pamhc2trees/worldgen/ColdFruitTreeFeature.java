...
public class ColdFruitTreeFeature extends Feature<NoFeatureConfig> {
	public ColdFruitTreeFeature(Codec<NoFeatureConfig> configFactory) {
		super(configFactory);
	}
	...
	private static BlockState getFruit(int verify, Random random)
	{
		...
		return BlockRegistry.pampinenut.defaultBlockState().setValue(BlockStateProperties.AGE_7, i);
